<template>
  <div class="node" :class="{ selected: data.selected }" :style="nodeStyles()" data-testid="node">
    ...
    <div class="title" v-if="type === 'start'" data-testid="title">Start</div>
    <div class="title" v-else-if="type === 'time_cond'" data-testid="title">{{ data.label }}</div>
    <div class="title" v-else-if="type === 'wait'" data-testid="title">{{ data.label }}</div>
    <!-- Outputs-->
